   ...
   <div class="modal-dialog">
      ...
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title panel-danger">Future Articles</h4>
         </div>
         <div class="modal-body">
            <p>These articles were added by me. All articles are shown here including unpublished ones.</p>
         </div>
   ...
   <div class="modal-dialog modal-dialog-full">
      ...
      <div class="modal-content modal-content-full">
         <div class="modal-header modal-header-full">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title modal-title-full">USER GUIDE - Future Articles</h4>
         </div>
         <div class="modal-body modal-body-full">
            @include('userGuide.articles.future')
         </div>
