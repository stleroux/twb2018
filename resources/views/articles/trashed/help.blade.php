   ...
   <div class="modal-dialog">
      ...
      <div class="modal-content">
         <div class="modal-header">
            ...
            <h4 class="modal-title panel-danger">Trashed Articles</h4>
         </div>
         <div class="modal-body">
            <p>
					These articles have been trashed and are not available for viewing by anyone except Managers and Administrators.
				</p>
         </div>
