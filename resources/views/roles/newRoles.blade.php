...
@section('breadcrumb')
    ...
    <li class="active"><span>New Roles</span></li>
@stop
         ...
         <div class="panel-heading" style="position:relative;">
            <h3 class="panel-title">
               <a href="#" id="popover" data-toggle="popover" data-trigger="hover"
                  ...
                  data-content="These roles have been added since you last logged in.">
                  <i class="fa fa-question-circle" aria-hidden="true"></i> New Roles
               </a>
