...
{{--
			<a href="{{ route('backend.articles.index') }}" class="list-group-item {{ Nav::hasSegment('articles', 2) }} {{ Nav::hasSegment('article', 2) }}">
			...
			<a href="{{ route('backend.items.index') }}" class="list-group-item {{ Nav::hasSegment('items', 2) }}">
			...
			<a href="{{ route('backend.albums.index') }}" class="list-group-item {{ Nav::hasSegment('albums', 2) }} {{ Nav::hasSegment('album', 2) }}">
				<i class="fa fa-leanpub" aria-hidden="true"></i>
				Photo Albums
			</a>
			...
			<a href="{{ route('backend.projects.index') }}" class="list-group-item {{ Nav::hasSegment('projects', 2) }}">
				<i class="fa fa-shopping-basket" aria-hidden="true"></i>
				Woodshop Projects
			</a>

			<a href="{{ route('backend.recipes.index') }}" class="list-group-item {{ Nav::hasSegment('recipes', 2) }}">
