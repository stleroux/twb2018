   ...
   @if($recipes->count() > 0)
      <div class="panel panel-primary">
         <div class="panel-heading" style="position:relative;">
            <h3 class="panel-title">
               <a href="#" id="popover" data-toggle="popover" data-trigger="hover"
                  ...
                  data-content="These recipes were added by me. All recipes are shown here including unpublished ones.">
                  <i class="fa fa-question-circle" aria-hidden="true"></i> My Recipes
               </a>
         ...
         <div class="well well-sm text text-center">
            <a href="{{ route('backend.recipes.myRecipes') }}" class="{{ Request::is('backend/recipes/myRecipes') ? "btn-primary": "btn-default" }} btn btn-sm">All</a>
            @foreach($letters as $value)
               <a href="{{ route('backend.recipes.myRecipes', $value) }}" class="{{ Request::is('backend/recipes/myRecipes/'.$value) ? "btn-primary": "btn-default" }} btn btn-sm">{{ strtoupper($value) }}</a>
            @endforeach
         </div>
