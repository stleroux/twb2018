...
@section ('content')
	...
	{!! Form::model($recipe, ['route'=>['backend.recipes.update', $recipe->id], 'method' => 'PUT', 'files' => true]) !!}
...
{{-- 			<div class="panel-footer">
				<div class="row">
					<div class="col-xs-12 col-sm-4 text-center">
						Created By @include('common.authorFormat', ['model'=>$recipe])
						on @include('common.dateFormat', ['model'=>$recipe, 'field'=>'created_at'])
					</div>
					<div class="col-xs-12 col-sm-4 text-center">
						Modified By @include('common.authorFormat', ['model'=>$recipe])
						on @include('common.dateFormat', ['model'=>$recipe, 'field'=>'updated_at'])
					</div>
					<div class="col-xs-12 col-sm-4 text-center">
						Last Viewed By @include('common.authorFormat', ['model'=>$recipe])
						on @include('common.dateFormat', ['model'=>$recipe, 'field'=>'last_viewed_on'])
					</div>
				</div>
			</div> --}}
...
@section('blocks')
		@include('backend.recipes.edit.controls')
	{!! Form::close() !!}
@stop
