	...
	<div class="panel-body">
		...
		<div class="col-xs-12 col-sm-4">
			<div class="form-group {{ $errors->has('stain_type_id') ? 'has-error' : '' }}">
				...
				{{ Form::select('stain_type_id', array('' => '-- Stain Type --') + $stainTypes, $project->stain_type_id , ['class' => 'form-control']) }}
		...
		<div class="col-xs-12 col-sm-4">
			<div class="form-group {{ $errors->has('stain_color_id') ? 'has-error' : '' }}">
				...
				{{ Form::select('stain_color_id', array('' => '-- Stain Color --') + $stainColors, $project->stain_color_id , ['class' => 'form-control']) }}
		...
		<div class="col-xs-12 col-sm-4">
			<div class="form-group {{ $errors->has('stain_sheen_id') ? 'has-error' : '' }}">
				...
				{{ Form::select('stain_sheen_id', array('' => '-- Stain Sheen --') + $stainSheens, $project->stain_sheen_id , ['class' => 'form-control']) }}
