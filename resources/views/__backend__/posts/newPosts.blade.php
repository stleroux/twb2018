...
@section('breadcrumb')
    ...
    <li class="active"><span>New Posts</span></li>
@stop
         ...
         <div class="panel-heading" style="position:relative;">
            <h3 class="panel-title">
               <a href="#" id="popover" data-toggle="popover" data-trigger="hover"
                  ...
                  data-content="These posts were added since you last logged in.">
                  <i class="fa fa-question-circle" aria-hidden="true"></i> New Posts
               </a>
