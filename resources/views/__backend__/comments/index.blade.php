         ...
         <div class="panel-heading" style="position:relative;">
            <h3 class="panel-title">
               <a href="#" id="popover" data-toggle="popover" data-trigger="hover"
                  ...
                  data-content=".">
                  <i class="fa fa-question-circle" aria-hidden="true"></i> Active Comments
               </a>
            ...
            <tbody>
               @foreach ($comments as $comment)
                  <tr>
                     ...
                     <td><a href="{{ route('backend.articles.show', $comment->commentable_id) }}">{{ $comment->commentable_id }}</a></td>
                     @if(checkACL('author'))
                        <td class="text-right">
