...
@section('breadcrumb')
    ...
    <li class="active"><span>New Users</span></li>
@stop
   ...
   @if($users->count() > 0)
      <div class="panel panel-primary">
         <div class="panel-heading" style="position:relative;">
            <h3 class="panel-title">
               <a href="#" id="popover" data-toggle="popover" data-trigger="hover"
                  ...
                  data-content=".">
                  <i class="fa fa-question-circle" aria-hidden="true"></i> New Users
               </a>
         ...
         <div class="well well-sm text text-center">
            <a href="{{ route('backend.users.newUsers') }}" class="{{ Request::is('backend/users/newUsers') ? "btn-primary": "btn-default" }} btn btn-sm">All</a>
            @foreach($letters as $value)
               <a href="{{ route('backend.users.newUsers', $value) }}" class="{{ Request::is('backend/users/newUsers/'.$value) ? "btn-primary": "btn-default" }} btn btn-sm">{{ strtoupper($value) }}</a>
            @endforeach
         </div>
