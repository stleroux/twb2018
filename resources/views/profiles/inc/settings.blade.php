{!! Form::model($user, ['route'=>['profile.updateSettings', $user->profile->id], 'method' => 'POST']) !!}
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">
					User Preferences 
					<span class="text-muted">(Features marked with	<i class="fa fa-check-square-o" aria-hidden="true"></i> have been implemented in code)</span>
				</h3>
			</div>
			...
			<div class="panel-body">
				...
				<div class="col-xs-6 col-sm-4 col-lg-3">
					<div class="panel panel-default">
						<div class="panel-heading">
							<h3 class="panel-title">Action Buttons
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							{{-- {{ Form::select('landing_page', array(
								...
								{{ Form::select('landing_page_id', $landingPages, $user->profile->landing_page_id , ['class' => 'form-control input-sm']) }}
						</div>
					</div>
				</div>
						...
						<div class="panel-body">
							<div class="btn-group" data-toggle="buttons">
								<label class="btn btn-default form-check-label {{ $user->profile->layout == 1 ? 'active' : '' }}">
									...
									<pre>@include('profiles.inc.layout1_preview')</pre>
									Layout 1 (Default)
								</label>
								<label class="btn btn-default form-check-label {{ $user->profile->layout == 2 ? 'active' : '' }}">
									...
									<pre>@include('profiles.inc.layout2_preview')</pre>
									Layout 2
								</label>
								<label class="btn btn-default form-check-label {{ $user->profile->layout == 3 ? 'active' : '' }}">
									...
									<pre>@include('profiles.inc.layout3_preview')</pre>
									Layout 3
								</label>
								<label class="btn btn-default form-check-label {{ $user->profile->layout == 4 ? 'active' : '' }}">
									...
									<pre>@include('profiles.inc.layout4_preview')</pre>
									Layout 4
								</label>
							</div>
						</div>
			...
			<div class="panel-footer">
				...
				<a href="{{ route('profile.resetSettings', $user->profile->id) }}" class="btn btn-xs btn-default">Reset All Defaults</a>
			</div>
