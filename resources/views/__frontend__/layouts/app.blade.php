			...
			<div class="col-xs-12">
				...
				@if(Auth::check())
					@if(Auth::user()->profile->layout == 1)
						@include('frontend.layouts.partials.lay_1')
					@elseif(Auth::user()->profile->layout == 2)
						@include('frontend.layouts.partials.lay_2')
					@elseif(Auth::user()->profile->layout == 3)
						@include('frontend.layouts.partials.lay_3')
					@elseif(Auth::user()->profile->layout == 4)
						@include('frontend.layouts.partials.lay_4')
					@endif
				@else
					@include('frontend.layouts.partials.lay_1')
				@endif
