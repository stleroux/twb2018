	...
	<div class="panel-body">
		...
		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
			<div class="form-group {{ $errors->has('finish_type_id') ? 'has-error' : '' }}">
				...
				{{ Form::select('finish_type_id', array('' => '-- Finish Type --') + $finishTypes, null , ['class' => 'form-control']) }}
		...
		<div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
			<div class="form-group {{ $errors->has('finish_sheen_id') ? 'has-error' : '' }}">
				...
				{{ Form::select('finish_sheen_id', array('' => '-- Finish Sheen --') + $finishSheens, null , ['class' => 'form-control']) }}
