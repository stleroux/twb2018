...
return [
    ...
    */
    'columns'   => [
        'alpha'   => [
            'rows'  => ['description', 'email', 'name', 'slug', 'status', 'company_name'],
            'class' => 'fa fa-sort-alpha',
        ],
        'amount'  => [
            'rows'  => ['amount', 'price', 'total', 'amount_charged', 'hst', 'sub_total', 'income_taxes', 'total_deductions', 'wsib'],
            'class' => 'fa fa-sort-amount',
        ],
        'numeric' => [
            'rows'  => ['created_at', 'updated_at', 'level', 'id', 'phone_number', 'invoiced_at', 'paid_at'],
