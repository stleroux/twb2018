...
##################################################################################################################
	 public function index($id)
	 {
		...
		return view('frontend.profiles.index', compact('user'))->withLandingPages($landingPages);
	}
...
##################################################################################################################
	...
	// 	return redirect()->route('frontend.profile', $id)->withInput(['tab'=>'settings']);
	//  }
...
##################################################################################################################
	 public function update(UpdateProfileRequest $request, $id)
	 {
		...
		return redirect()->route('profile', $profile->id)->withInput(['tab'=>'profile']);
	 }
