...
##################################################################################################################
	public function archive($year, $month)
	{
		...
		return view('frontend.blog.archive', compact('archives','postlinks'))->withYear($year)->withMonth($month);
	}
...
##################################################################################################################
	public function getIndex()
	{
		...
		// return view ('frontend.blog.index', compact('posts','popularPost'));
		return view ('frontend.blog.index', compact('posts','postlinks'));
	}
...
##################################################################################################################
	public function print($id)
	{
		...
		return view('frontend.blog.print', compact('post'));
	}
...
##################################################################################################################
	 public function search(Request $request)
	 {
		...
		$postlinks = DB::table('posts')
		  ...
		  return view('frontend.blog.search', compact('posts','postlinks'));
	 }
...
##################################################################################################################
	public function getSingle($slug)
	{
		...
		return view('frontend.blog.single', compact('post','postlinks','next','previous'));
	}
